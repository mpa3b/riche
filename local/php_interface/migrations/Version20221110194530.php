...
class Version20221110194530 extends Version
{
...
',
  ...
  'MODULE_ID' => 'main',
  'NAME' => 'email_from',
  'VALUE' => 'ilya.petrovsky@yandex.ru',
));
        $helper->Option()->saveOption(array (
  'MODULE_ID' => 'main',
  ...
  array (
    ...
    array (
      'ID' => 'sprint.editor',
      'NAME' => 'Редактор для контент-менеджеров',
      'TMS' => 1667988318,
    ),
    1 => 
    array (
  ...
  'VALUE' => '10.11.2022 19:36:33',
));
        $helper->Option()->saveOption(array (
  'MODULE_ID' => 'main',
  'NAME' => 'update_system_update',
  'VALUE' => '09.11.2022 13:24:44',
));
        $helper->Option()->saveOption(array (
  'MODULE_ID' => 'main',
  'NAME' => 'upload_dir',
  ...
  'VALUE' => '60cb226b91403b764707a80013c33cd5',
));
        $helper->Option()->saveOption(array (
  'MODULE_ID' => 'sprint.migration',
  'NAME' => 'schema_eventschema',
  'VALUE' => 'dda634f78adaae354bb02b2344cf9ad6',
));
        $helper->Option()->saveOption(array (
  'MODULE_ID' => 'sprint.migration',
  ...
  'VALUE' => 'b57f4e415e2fc831fa2d89bcbb1b2ddb',
));
        $helper->Option()->saveOption(array (
  'MODULE_ID' => 'sprint.migration',
  'NAME' => 'schema_optionschema',
  'VALUE' => 'bcc0cc1a0e40bc0b215c1ce5c3c50893',
));
        $helper->Option()->saveOption(array (
  'MODULE_ID' => 'sprint.migration',
