...
<div class="catalog--default element shop--element">
    ...
    if ($cache->initCache(CACHE_TTL, 'recommend_' . $elementId)) {

        $recommendData = $cache->getVars();
    ...
    elseif ($cache->startDataCache()) {
        ...
        $rsProps = CIBlockProperty::GetList(
            ['SORT' => 'ASC', 'ID' => 'ASC'],
            ['IBLOCK_ID' => $arParams['IBLOCK_ID'], 'PROPERTY_TYPE' => 'E', 'ACTIVE' => 'Y']
        );
        ...
        $cache->endDataCache($recommendData);
    ...
    if ($arParams['DETAIL_SHOW_VIEWED'] == 'Y') {
        ...
        $APPLICATION->IncludeComponent(
            ...
            [
                ...
                'USE_PRICE_COUNT'    => $arParams['USE_PRICE_COUNT'],
                'SHOW_PRICE_COUNT'   => $arParams['SHOW_PRICE_COUNT'],
                'PAGE_ELEMENT_COUNT' => $arParams['LINE_ELEMENT_COUNT'],
                ...
                'SHOW_FROM_SECTION'                       => $arParams['DETAIL_SHOW_VIEWED_FROM_SECTION'],
                'SHOW_PRODUCTS_' . $arParams['IBLOCK_ID'] => 'Y',
