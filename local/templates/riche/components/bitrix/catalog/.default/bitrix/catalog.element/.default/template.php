...
$this->addExternalJs(LOCAL_ASSETS . '/jquery-colorbox/jquery.colorbox.js');
$this->addExternalCss(SITE_TEMPLATE_PATH . '/styles/colorbox.css');

?>

<article class="catalog--default--element--default wrap"
         data-id="<?= $arResult['ID']; ?>"
                            ...
                            <div class="images slider items">
                                ...
                                <?php foreach ($arResult['DISPLAY_PROPERTIES']['HOW_TO_USE_IMAGES']['VALUE'] as $image) { ?>
                                    ...
                                    <div class="item">
                                        ...
                                        <a href="<?= $wide['src']; ?>" class="colorbox" rel="how-to-use">
